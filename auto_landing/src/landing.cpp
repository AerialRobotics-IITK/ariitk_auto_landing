...
void Landing::mavCommandCallback(const geometry_msgs::PoseStamped& msg) { mav_command_ = msg; }

void Landing::mavOdometryCallback(const nav_msgs::Odometry& msg) { mav_odometry_ = msg; }
