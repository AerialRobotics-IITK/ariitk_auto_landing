...
TrajectoryGenerationTracking::TrajectoryGenerationTracking(char** argv) : dimension_(3), nh_(), nh_private_("~"), platform_acceleration_(0, 0, 0) {
...
void TrajectoryGenerationTracking::mavOdometryCallback(const nav_msgs::Odometry& msg) { mav_odom_ = msg; }
